...
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'snapshots/CS2DensePASS_Trans4PASS_v1_WarmUp/BestCS2DensePASS_500iter_41.58miou.pth'
#'snapshots/CS2DensePASS_Trans4PASS_v1_WarmUp/BestCS2DensePASS_G.pth'
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 100
...
def main():
    ...
    if not os.path.exists(init_mem_j_path):
        trainset_temp = PANODataSet(args.data_dir_target, args.data_list_target, crop_size=input_size_target, set='train',
                                         ssl_dir=SSL_DIR)

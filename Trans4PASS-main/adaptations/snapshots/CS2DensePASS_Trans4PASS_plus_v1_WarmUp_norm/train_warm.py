...
NUM_CLASSES = 19
NUM_STEPS = 21000
NUM_STEPS_STOP = 21000 # early stopping
NUM_PROTOTYPE = 50
POWER = 0.9
RANDOM_SEED = 1234
RESTORE_FROM = 'workdirs/cityscapes/trans4pass_plus_tiny_512x512/trans4pass_plus_tiny_512x512.pth'
# RESTORE_FROM = 
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 1000
# SAVE_PRED_EVERY = 1000
DIR_NAME = '{}2{}_{}_WarmUp_norm/'.format(SOURCE_NAME, TARGET_NAME, MODEL)
# SNAPSHOT_DIR = './snapshots_fixoffset/' + DIR_NAME
...
def main():
    ...
    # init D
    model_D = FCDiscriminator_norm(num_classes=args.num_classes).to(device)#全卷积判别器

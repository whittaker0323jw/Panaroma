    ...
    def _map19to13(self, mask):
        ...
        for value in values:
            if value == 255: 
                ...
                # print("values:",values)
                # print("values_length:",values.size)
                #print("mask:", mask)
                print("value:",value)
                id = np.where(values == value)[0]  
                new_mask[mask==value] = self._key[id]
...
if __name__ == '__main__':
    ...
    trainloader = data.DataLoader(dst, batch_size=4) #可能有问题的batch size
